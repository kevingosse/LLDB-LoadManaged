...
struct ILLDBServices : public IUnknown
{
public:
//----------------------------------------------------------------------------
// ILLDBServices
...
HRESULT virtual GetModuleParameters(
        ULONG count,
        PULONG64 bases,
        ULONG start,
...
HRESULT virtual GetModuleNameString(
            ULONG   Which,
            ULONG   Index,
            ULONG64 Base,
            PSTR    Buffer,
...
HRESULT virtual IsPointer64Bit() = 0;
